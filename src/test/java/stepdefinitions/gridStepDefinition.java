...
public class gridStepDefinition {
    ...
    public void get_url() throws MalformedURLException {
        driver= new RemoteWebDriver( new URL("http://192.168.0.172:4444"), new ChromeOptions());
    ...
    public void get_url_firefox() throws MalformedURLException {
        ...
        driver= new RemoteWebDriver(new URL("http://192.168.0.178:4444"), new EdgeOptions());
